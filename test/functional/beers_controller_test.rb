...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brewery: @beer.brewery, note: @beer.note, rating: @beer.rating, title: @beer.title, wishlist: @beer.wishlist }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { brewery: @beer.brewery, note: @beer.note, rating: @beer.rating, title: @beer.title, wishlist: @beer.wishlist }
    assert_redirected_to beer_path(assigns(:beer))
  end
